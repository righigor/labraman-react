...
export default function HomeHistoria() {
  ...
  return (
    <section className="w-full h-screen flex justify-center bg-black">
      <div className="relative w-full h-[90%] bg-backgroundLight rounded-b-[4rem] flex items-center justify-center will-change-transform will-change-opacity">
        <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center px-12">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-6">{t("historia_home")}</p>
